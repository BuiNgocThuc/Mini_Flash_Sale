...
public enum ErrorCode {
    ...
    USERNAME_INVALID(1008, "Username phải có ít nhất 4 ký tự", HttpStatus.BAD_REQUEST),
    PASSWORD_INVALID(109, "Password phải có ít nhất 8 ký tự", HttpStatus.BAD_REQUEST),
    EMAIL_INVALID(1010, "Định dạng Email không hợp lệ", HttpStatus.BAD_REQUEST),
    FIELD_REQUIRED(1011, "Trường này không được để trống", HttpStatus.BAD_REQUEST),
